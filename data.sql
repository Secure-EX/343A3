...
INSERT INTO model (id, name, vehicle_type, model_number, capacity)
VALUES
  (1, 'BMW X5', 'SUV', 415, 5),
...
INSERT INTO car (id, license_plate_number, station_code, model_id)
VALUES
  (101, 'torc566', 1001, 1),
  (102, 'torc212', 1001, 8),
  (103, 'torc631', 1001, 7),
...
INSERT INTO reservation (id, from_date, to_date, car_id, old_reservation_id, status)
VALUES
...
INSERT INTO customer_reservation (customer_email, reservation_id)
VALUES
  ('j.s@mail.com', 22001),
